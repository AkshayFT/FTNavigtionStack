...
enum SidebarTopSectionElement {
    ...
    var iconTint: Color {
        ...
        switch self {
        case .home:
            color = Color(uiColor: UIColor(named: "homeIconTint")!)
        case .starred:
            color = Color(uiColor: UIColor(named: "starredIconTint")!)
        case .trash:
            color = Color(uiColor: UIColor(named: "trashIconTint")!)
        case .unfiled:
            color = Color(uiColor: UIColor(named: "unfiledIconTint")!)
        }
        return color
    }
}
